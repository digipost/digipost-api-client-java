...
import static no.posten.dpost.api.client.Headers.X_Digipost_UserId;
import static no.posten.dpost.api.client.representations.MediaTypes.DIGIPOST_MEDIA_TYPE_V1;
...
import no.posten.dpost.api.client.representations.EntryPoint;
import no.posten.dpost.api.client.representations.ErrorMessage;
import no.posten.dpost.api.client.representations.Link;
import no.posten.dpost.api.client.representations.MediaTypes;
